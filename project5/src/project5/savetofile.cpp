...
void savetofile::save_standard_diviation(int sigma1, int sigma2, int sigma3, int b){
    ofstream outfile2;
    outfile2.open("../result/sigma_mc_b_" + to_string(b) +"_acddief_"+ number_arg + ".txt");
    outfile2 <<setw(12) << setprecision(6) << sigma1
             <<setw(12) << setprecision(6) << sigma2
             <<setw(12) << setprecision(6) << sigma3 << endl;
    outfile2.close();
}
